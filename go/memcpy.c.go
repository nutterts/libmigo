...
func ___memcpy_by4 (*byte, *byte, uint32) *byte __asm__("__memcpy_by4")
func ___memcpy_by2 (*byte, *byte, uint32) *byte __asm__("__memcpy_by2")
func ___memcpy_g (*byte, *byte, uint32) *byte __asm__("__memcpy_g")
