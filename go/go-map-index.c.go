...
type ___go_map_descriptor struct { __map_descriptor *___go_map_type; __entry_size uint32; __key_offset uint32; __val_offset uint32; }
const _sizeof___go_map_descriptor = 16
type ___go_map struct { __descriptor *___go_map_descriptor; __element_count uint32; __bucket_count uint32; __buckets **byte; }
const _sizeof___go_map = 16
type ___go_hash_iter struct { entry *byte; _map *___go_map; next_entry *byte; bucket uint32; }
const _sizeof___go_hash_iter = 16
func ___go_map_index (*___go_map, *byte, bool) *byte __asm__("__go_map_index")
...
func _runtime_roundupsize (uint32) uint32 __asm__("runtime_roundupsize")
func ___go_assert_fail (*int8, uint32) __asm__("__go_assert_fail")
...
func ___go_new_map (*___go_map_descriptor, uint32) *___go_map __asm__("__go_new_map")
func ___go_map_next_prime (uint32) uint32 __asm__("__go_map_next_prime")
func ___go_map_index (*___go_map, *byte, bool) *byte __asm__("__go_map_index")
func ___go_map_delete (*___go_map, *byte) __asm__("__go_map_delete")
func ___go_mapiterinit (*___go_map, *___go_hash_iter) __asm__("__go_mapiterinit")
func ___go_mapiternext (*___go_hash_iter) __asm__("__go_mapiternext")
func ___go_mapiter1 (*___go_hash_iter, *uint8) __asm__("__go_mapiter1")
func ___go_mapiter2 (*___go_hash_iter, *uint8, *uint8) __asm__("__go_mapiter2")
