...
func ___go_new_nopointers (*___go_type_descriptor, uint32) *byte __asm__("__go_new_nopointers")
...
func ___go_new (*___go_type_descriptor, uint32) *byte __asm__("__go_new")
func ___go_new_nopointers (*___go_type_descriptor, uint32) *byte __asm__("__go_new_nopointers")
