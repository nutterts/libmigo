...
func ___go_type_hash_string (*byte, uint32) uint32 __asm__("__go_type_hash_string")
func ___go_type_equal_string (*byte, *byte, uint32) bool __asm__("__go_type_equal_string")
...
func ___go_get_rune (*uint8, uint32, *int32) int32 __asm__("__go_get_rune")
func ___go_type_hash_string (*byte, uint32) uint32 __asm__("__go_type_hash_string")
func ___go_type_equal_string (*byte, *byte, uint32) bool __asm__("__go_type_equal_string")
