...
type ___go_open_array struct { __values *byte; __count int32; __capacity int32; }
const _sizeof___go_open_array = 12
type _PageID uint32
func ___go_string_to_byte_array (_String) ___go_open_array __asm__("__go_string_to_byte_array")
