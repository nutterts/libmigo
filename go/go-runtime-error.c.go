...
func ___go_runtime_error (int32) __asm__("__go_runtime_error")
...
const _ARRAY_SLICE_OUT_OF_BOUNDS = 4
...
const _SLICE_SLICE_OUT_OF_BOUNDS = 3
...
const _STRING_SLICE_OUT_OF_BOUNDS = 5
...
const _STRING_INDEX_OUT_OF_BOUNDS = 2
...
const _MAKE_SLICE_OUT_OF_BOUNDS = 7
...
const _MAKE_CHAN_OUT_OF_BOUNDS = 9
const ___DEC32_EPSILON__ = 1E-6
const ___ELF__ = 1
const _NIL_DEREFERENCE = 6
...
const _MAKE_MAP_OUT_OF_BOUNDS = 8
